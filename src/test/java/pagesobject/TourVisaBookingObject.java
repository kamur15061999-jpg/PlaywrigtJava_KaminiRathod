...
public class TourVisaBookingObject {
    ...
    public void clickActivities() {
        page.getByRole(AriaRole.LINK,
                new Page.GetByRoleOptions().setName("Activities Activities")).click();
    }

    public void goToDubaiActivities() {
        page.getByRole(AriaRole.LINK,
                new Page.GetByRoleOptions().setName("Things to do in Dubai United")).click();
    }
    ...
    public void selectCruiseFlow() {
        ...
        page.getByRole(AriaRole.LINK,
                new Page.GetByRoleOptions().setName("Recommended creek_cruise Dhow")).click();
    ...
    public void selectTourDateGuests() {
        page.getByRole(AriaRole.BUTTON,
                new Page.GetByRoleOptions().setName("More dates")).click();

        page.getByTestId("DateInput.button[1]").click();
        page.getByRole(AriaRole.BUTTON,
                new Page.GetByRoleOptions().setName("19")).nth(2).click();
    ...
    public void fillVisaDetails() {
        page.getByTestId("ResidencyInput.div[1]").getByRole(AriaRole.BUTTON,
                new Locator.GetByRoleOptions().setName("Select")).click();
